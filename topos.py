...
parser.add_argument(
        ...
        type=int,
        help=(
            'Number of most informative genes to consider.\n' + 
...
if args.normalization == 'self':
    ...
    print('2. Normalizing data matrix according to "self" method.\n',
          '------------------------------------------------------\n\n',
          'Normalization on user\'s data is independent from training\n',
          flush=True)
    ...
    print('2. Normalizing data matrix according to "train" method.\n',
          '-------------------------------------------------------\n\n',
...
if args.load_model is None:    
    ...
    print('3. Trained classifier on {} genes\n'.format(X_train_scl.shape[1]),
          '----------------------------------\n\n',
          'This number can be\n\n',
    ...
    print(('3. Loaded pre-trained classifier ' + 
...
print('... Wrote predictions to {}'.format(args.output_predictions),
      '...\n\n', 
